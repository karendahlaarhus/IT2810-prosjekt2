      ...
      >
        <path
          ...
          d="M200 10 C 180 10, 160 10, 160 30H 240H 160C 160 30, 145 30, 145 50
                ...
                H 280
                H 130
                C 130 70, 115 70, 115 90
                H 300
                H 115
                C 115 90, 100 90, 100 110
                H 310
                H 100
                C 100 110, 100 130, 115 130
                H 300
                H 115
                C 115 130, 115 150, 130 150
                H 280
                H 130
                C 130 150, 130 170, 145 170
                H 270
                H 145
                C 145 170, 145 190, 160 190
                H 250
                H 160
                C 160 190, 160 210, 175 210
                C 180 210, 190 210, 200 210
                C 200 210, 210 210, 240 210

                C 240 210, 260 210, 260 190
                C 260 190, 275 190, 275 170
                C 275 170, 290 170, 290 150
                C 290 150, 305 150, 305 130
                C 305 130, 320 130, 320 110
                C 320 110, 320 90, 305 90
                C 305 90, 305 70, 290 70
        ...
        <path
          ...
          d="M200 10 
                ...
                C 200 210, 185 210, 185 190
                C 185 190, 170 190, 170 170
                C 170 170, 155 170, 155 150
                C 155 150, 140 150, 140 130
                C 140 130, 125 130, 125 110
                C 125 110, 125 90, 140 90
                C 140 90, 140 70, 155 70
                C 155 70, 155 50, 170 50
                C 170 50, 170 30, 185 30
                C 185 30, 185 10, 200 10
                "
          stroke="none"
          fill="black"
          fill-opacity="0.3"
        ...
        <ellipse cx="210" cy="160" rx="20" ry="20" fill="black" />
        ...
        <g id="bee-path" transform="translate(85,45)">
          <path
            ...
            stroke="none"
            strokeMiterlimit="10"
            d="M41.903,113.081c0,0-27,24-2,34s50-15,50-15s90-55,119-17
          ...
          <g id="bee" transform="translate(-234.4, -182.8)">
            <ellipse cx="234.4" cy="189.2" rx="10" ry="7" fill="black" />
            <rect x="230" y="182" width="2" height="14" fill="yellow" />
            <rect x="238" y="182" width="2" height="14" fill="yellow" />
            <ellipse
              cx="240"
              cy="200"
              rx="4"
        ...
        <g id="bee-path2" transform="translate(85,45)">
          <path
            ...
            stroke="none"
            strokeMiterlimit="10"
            d="M197.99,18c0,0-135.63,174.71-164.992,121.494
          ...
          <g id="bee2" transform="translate(-234.4, -182.8)">
            <ellipse cx="234.4" cy="189.2" rx="10" ry="7" fill="black" />
            <rect x="230" y="182" width="2" height="14" fill="yellow" />
            <rect x="238" y="182" width="2" height="14" fill="yellow" />
            <ellipse
        ...
        <g id="bee-path3" transform="translate(85,45)">
          <path
            ...
            stroke="none"
            strokeMiterlimit="10"
            d="M146.993,56.998c0,0,106.493-56.998-12-56.998
          ...
          <g id="bee3" transform="translate(-234.4, -182.8)">
            <ellipse cx="234.4" cy="189.2" rx="10" ry="7" fill="black" />
            <rect x="230" y="182" width="2" height="14" fill="yellow" />
            <rect x="238" y="182" width="2" height="14" fill="yellow" />
            <ellipse
        ...
        <g id="bee-path4" transform="translate(85,45)">
          <path
            ...
            stroke="none"
            strokeMiterlimit="10"
            d="M158.992,0c0,0-83.996,1.5-38.998,29.999s89.995,32.999,52.497,56.998
        ...
        <g id="bee-path5" transform="translate(85,45)">
          <path
            ...
            stroke="none"
            strokeMiterlimit="10"
            d="M65.997,13.5c0,0-46.499-23.999-38.999,1.5
          ...
          <g id="bee5" transform="translate(-234.4, -182.8)">
            <ellipse cx="234.4" cy="189.2" rx="10" ry="7" fill="black" />
            <rect x="230" y="182" width="2" height="14" fill="yellow" />
            <rect x="238" y="182" width="2" height="14" fill="yellow" />
            <ellipse
        ...
        <animateMotion
          ...
          rotate="auto"
        >
          <mpath xlinkHref="#motionPath5" />
        </animateMotion>

        <animateTransform
          xlinkHref="#left-honey"
